...
#ifndef DMS_INTERFACES__SRV__DETAIL__GET_BATTERY_LEVEL__FUNCTIONS_H_
#define DMS_INTERFACES__SRV__DETAIL__GET_BATTERY_LEVEL__FUNCTIONS_H_
...
/// Initialize srv/GetBatteryLevel message.
/**
...
/// Finalize srv/GetBatteryLevel message.
/**
...
/// Create srv/GetBatteryLevel message.
/**
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * dms_interfaces__srv__GetBatteryLevel_Request__init().
...
/// Destroy srv/GetBatteryLevel message.
/**
 * It calls
 * dms_interfaces__srv__GetBatteryLevel_Request__fini()
...
/// Check for srv/GetBatteryLevel message equality.
/**
...
/// Copy a srv/GetBatteryLevel message.
/**
...
/// Initialize array of srv/GetBatteryLevel messages.
/**
...
/// Finalize array of srv/GetBatteryLevel messages.
/**
 * It calls
 * dms_interfaces__srv__GetBatteryLevel_Request__fini()
...
/// Create array of srv/GetBatteryLevel messages.
/**
 * It allocates the memory for the array and calls
 * dms_interfaces__srv__GetBatteryLevel_Request__Sequence__init().
 * \param[in] size The size / capacity of the array.
...
/// Destroy array of srv/GetBatteryLevel messages.
/**
 * It calls
 * dms_interfaces__srv__GetBatteryLevel_Request__Sequence__fini()
 * on the array,
...
/// Check for srv/GetBatteryLevel message array equality.
/**
...
/// Copy an array of srv/GetBatteryLevel messages.
/**
 * This functions performs a deep copy, as opposed to the shallow copy that
 * plain assignment yields.
 *
 ...
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * dms_interfaces__srv__GetBatteryLevel_Response__init().
 * \return The pointer to the initialized message if successful,
 * otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_dms_interfaces
...
/**
 * It calls
 * dms_interfaces__srv__GetBatteryLevel_Response__fini()
 * and frees the memory of the message.
 * \param[in,out] msg The allocated message pointer.
 */
ROSIDL_GENERATOR_C_PUBLIC_dms_interfaces
...
/**
 * It allocates the memory for the array and calls
 * dms_interfaces__srv__GetBatteryLevel_Response__Sequence__init().
 * \param[in] size The size / capacity of the array.
 * \return The pointer to the initialized array if successful, otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_dms_interfaces
...
/**
 * It calls
 * dms_interfaces__srv__GetBatteryLevel_Response__Sequence__fini()
 * on the array,
 * and frees the memory of the array.
 * \param[in,out] array The initialized array pointer.
 */
...
#endif  // DMS_INTERFACES__SRV__DETAIL__GET_BATTERY_LEVEL__FUNCTIONS_H_
