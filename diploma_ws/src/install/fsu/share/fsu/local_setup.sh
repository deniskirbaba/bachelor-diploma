...
: ${AMENT_CURRENT_PREFIX:="/home/denis/diploma_ws/src/install/fsu"}
...
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/fsu/environment/ament_prefix_path.sh"
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/fsu/environment/path.sh"
