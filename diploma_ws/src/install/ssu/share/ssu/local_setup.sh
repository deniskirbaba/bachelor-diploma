...
: ${AMENT_CURRENT_PREFIX:="/home/denis/diploma_ws/src/install/ssu"}
...
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/ssu/environment/ament_prefix_path.sh"
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/ssu/environment/path.sh"
