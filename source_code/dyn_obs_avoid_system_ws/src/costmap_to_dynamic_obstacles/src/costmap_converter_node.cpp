...
to the background_subtractor and blob detector.
...
#include <costmap_to_dynamic_obstacles/costmap_to_dynamic_obstacles.hpp>
...
class CostmapConversionNode : public rclcpp::Node 
{
    public:
        CostmapConversionNode() : Node("costmap_converter_node")
        {
            ...
            obstacle_pub_ = this->create_publisher<dms_interfaces::msg::ObstacleArray>(
        ...
        void publishAsMarker(
            ...
            const dms_interfaces::msg::ObstacleArray &obstacles) 
        {
    ...
    private:
        ...
        rclcpp::Publisher<dms_interfaces::msg::ObstacleArray>::SharedPtr obstacle_pub_;
